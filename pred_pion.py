...
df_test_pion = pd.read_pickle('3D-Data/GNN-3D-150Gev_pion.pkl')
X_batch_pion, y_batch_pion = get_Xbatch_ybatch(df_test_pion)
...
# test_model_scaled = tf.keras.models.load_model('model_checkpoints/adam_batch/GNN_3D_RecoHits_pip_adam_batch.loss_0.008628.ep005.h5')
# test_model_adam = tf.keras.models.load_model('model_checkpoints/adam_models/GNN_3D_RecoHits_pip_adam.loss_0.009124.ep002.h5')
# test_model_batch = tf.keras.models.load_model('model_checkpoints/batch/GNN_3D_RecoHits_pip_batch.loss_0.009406.ep003.h5')
# test_model_normal = tf.keras.models.load_model('model_checkpoints/normal/GNN_3D_RecoHits_pip_normal.loss_0.009097.ep003.h5')

#old models with 500k events
...
prediction_scaled_1= test_model_scaled.predict(X_batch_pion, batch_size=24)
prediction_adam_1= test_model_adam.predict(X_batch_pion, batch_size=24)
prediction_batch_1= test_model_batch.predict(X_batch_pion, batch_size=124)
prediction_normal_1= test_model_normal.predict(X_batch_pion, batch_size=24)
...
pred_save.to_pickle('3D-Data/prediction/prediciton_pion_{}.pkl'.format(tag))
