...
prediction_normal=np.array(pd.read_pickle('3D-Data/prediction/prediciton_photon_normal_800k.pkl')).flatten()
prediction_adam=np.array(pd.read_pickle('3D-Data/prediction/prediciton_photon_adam_800k.pkl')).flatten()
prediction_adam_batch=np.array(pd.read_pickle('3D-Data/prediction/prediciton_photon_adam_batch_800k.pkl')).flatten()
prediction_batch=np.array(pd.read_pickle('3D-Data/prediction/prediciton_photon_batch_800k.pkl')).flatten()

#load in all test arrays for simple sum

test_normal  = pd.read_pickle('3D-Data/GNN-3D-150Gev_photon.pkl')
test_adam  = pd.read_pickle('3D-Data/GNN-3D-150Gev_photon.pkl')
test_adam_batch  = pd.read_pickle('3D-Data/GNN-3D-150Gev_photon.pkl')
test_batch  =pd.read_pickle('3D-Data/GNN-3D-150Gev_photon.pkl')
...
ax.set_title('Response W Simple Sum and GNN model  photon')
ax.set_ylim(0,2)
pos = ax.get_position()
ax.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax.legend(loc='upper right')
plt.savefig('plots_800k/response_photon_normal.png')
plt.close()
plt.figure(2)
...
ax1.set_title('Resoltuion W Simple Sum and GNN model photon')
ax1.set_ylim(0,1)
pos = ax1.get_position()
ax1.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax1.legend(loc='upper right')
plt.savefig('plots_800k/resoltuion_photon_normal.png')
plt.close()
...
ax13.set_title('Response W Simple Sum and GNN model  photon')
ax13.set_ylim(.95,1.35)
pos = ax13.get_position()
ax13.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax13.legend(loc='upper right')
plt.savefig('plots_800k/response_photon_scaled.png')
plt.close()
plt.figure(14)
...
ax14.set_title('Resoltuion W Simple Sum and GNN model photon')
ax14.set_ylim(0,.5)
pos = ax14.get_position()
ax14.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax14.legend(loc='upper right')
plt.savefig('plots_800k/resoltuion_photon_scaled.png')
plt.close()
plt.figure(3)
...
ax2.set_title('ratio GNN model 1t5  photon')
#ax2.set_xlim(-0.2,3)                                                                                                                                                   
plt.yscale('linear')
pos = ax2.get_position()
ax2.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax2.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_1t5_photon_normal.png')
plt.close()
...
ax3.set_title('ratio GNN model 5t10 photon')
#ax3.set_xlim(0,2.5)                                                                                                                                                    
plt.yscale('linear')
pos = ax3.get_position()
ax3.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax3.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_5t10_photon_normal.png')
plt.close()
plt.figure(5)
...
ax5.set_title('ratio GNN model 10t20 photon')
plt.yscale('linear')
#ax5.set_xlim(0,2.5)                                                                                                                                                    
pos = ax5.get_position()
ax5.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax5.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_10t20_photon_normal.png')
plt.close()
...
ax6.set_title('ratio GNN model 20t30 photon')
plt.yscale('linear')
#ax6.set_xlim(.5,1.5)                                                                                                                                                    
pos = ax6.get_position()
ax6.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax6.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_20t30_photon_normal.png')
plt.close()
...
ax7.set_title('ratio GNN model 30t40 photon')
plt.yscale('linear')
#ax7.set_xlim(.25,1.75)                                                                                                                                                 
pos = ax7.get_position()
ax7.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax7.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_30t40_photon_normal.png')
plt.close()
plt.figure(8)
...
ax8.set_title('ratio GNN model 40t60 photon')
plt.yscale('linear')
#ax8.set_xlim(.25,1.75)                                                                                                                                                 
pos = ax8.get_position()
ax8.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax8.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_40t60_photon_normal.png')
plt.close()
...
ax9.set_title('ratio GNN model 60t80 photon')
plt.yscale('linear')
#ax9.set_xlim(.25,1.75)                                                                                                                                                 
pos = ax9.get_position()
ax9.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax9.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_60t80_photon_normal.png')
plt.close()
plt.figure(10)
...
ax10.set_title('ratio GNN model 80t100 photon')
plt.yscale('linear')
#ax10.set_xlim(.25,1.75)                                                                                                                                                
pos = ax10.get_position()
ax10.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax10.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_80t100_photon_normal.png')
plt.close()
...
ax11.set_title('ratio GNN model 100t120 photon')
plt.yscale('linear')
#ax11.set_xlim(0,1.75)                                                                                                                                                  
pos = ax11.get_position()
ax11.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax11.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_100t120_photon_normal.png')
plt.close()
plt.figure(12)
...
ax12.set_title('ratio GNN model 120t150 photon')
#ax12.set_xlim(0,1.4)                                                                                                                                                  
plt.yscale('linear')
pos = ax12.get_position()
ax12.set_position([pos.x0, pos.y0, pos.width * 0.9, pos.height])
ax12.legend(loc='upper right')
plt.savefig('plots_800k/response_hist_120t150_photon_normal.png')
plt.close()
